...
- Fri jun 13
  ...
  - added crazy graceful shutdown so it saves exactly upon ctrl+c. Cursed SIGINT handlers and `except KeyboardInterrupt` and `if self._interrupted` logic. It works. Did I use copilot? Of course. Such is programming these days. I can feel it. It's becoming real now.
